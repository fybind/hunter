...
from config import ADMINS, FORCE_SUB_CHANNEL, FORCE_SUB_GROUP, FORCE_SUB_GROUP1
...
async def subsgroup1(filter, client, update):
...
subsgc1 = filters.create(subsgroup1)
